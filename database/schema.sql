...
CREATE TABLE visitor_sessions (
    ...
    INDEX idx_sessions_first_seen (first_seen DESC),
    INDEX idx_sessions_submitted (submitted_inquiry)
);
...
CREATE TABLE page_views (
    ...
    INDEX idx_pageviews_url (page_url),
    INDEX idx_pageviews_viewed (viewed_at DESC)
);
